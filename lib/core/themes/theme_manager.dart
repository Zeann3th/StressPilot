...
class ThemeManager with ChangeNotifier {
  ...
  static final _fleetTheme = PilotTheme(
    ...
    colors: {
      ...
      'elevated': const Color(0xFF1D2129),
      'activeItem': const Color(0xFF253042),
      'hoverItem': const Color(0xFF20252E),
      'accent': const Color(0xFF4C8DFF),
      'accentHover': const Color(0xFF6FA4FF),
      'accentActive': const Color(0xFF2F73E6),
      'border': const Color(0x24D8E0EA),
      'divider': const Color(0x14D8E0EA),
      'textPrimary': const Color(0xFFE4E7EC),
      'textSecondary': const Color(0xFFA1A8B3),
      'textDisabled': const Color(0xFF667080),
      'success': const Color(0xFF63B179),
      'info': const Color(0xFF4C8DFF),
      'warning': const Color(0xFFD2A84F),
      'error': const Color(0xFFE06C75),
      'methodDelete': const Color(0xFFE06C75),
      'methodPatch': const Color(0xFFB08CFF),
    },
  );
