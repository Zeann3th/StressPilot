...
class PilotContextMenuItem {
  ...
  const PilotContextMenuItem({this.label, this.icon, this.onTap, this.builder});

  static PilotContextMenuItem divider() =>
      PilotContextMenuItem(builder: (context) => const Divider(height: 1));
}
...
class PilotContextMenu extends StatelessWidget {
  ...
  const PilotContextMenu({super.key, required this.items, required this.child});
