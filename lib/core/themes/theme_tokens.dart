...
abstract class AppColors {
  ...
  static const _fallbackBackground = Color(0xFF101216);
  static const _fallbackSidebar = Color(0xFF171A20);
  static const _fallbackElevated = Color(0xFF1D2129);
  static const _fallbackActive = Color(0xFF253042);
  static const _fallbackHover = Color(0xFF20252E);
  static const _fallbackAccent = Color(0xFF4C8DFF);
  static const _fallbackText = Color(0xFFE4E7EC);
  static const _fallbackSecondary = Color(0xFFA1A8B3);
  static const _fallbackDisabled = Color(0xFF667080);
  ...
  static Color get baseBackground => _theme.getColor(
    'background',
    _theme.isDark ? _fallbackBackground : AppColorsLight.baseBackground,
  );
  static Color get sidebarBackground => _theme.getColor(
    'surface',
    _theme.isDark ? _fallbackSidebar : AppColorsLight.sidebarBackground,
  );
  static Color get elevatedSurface => _theme.getColor(
    'elevated',
    _theme.isDark ? _fallbackElevated : AppColorsLight.elevatedSurface,
  );
  static Color get activeItem => _theme.getColor(
    'activeItem',
    _theme.isDark ? _fallbackActive : AppColorsLight.activeItem,
  );
  static Color get hoverItem => _theme.getColor(
    'hoverItem',
    _theme.isDark ? _fallbackHover : AppColorsLight.hoverItem,
  );
  static Color get accent => _theme.getColor(
    'accent',
    _theme.isDark ? _fallbackAccent : AppColorsLight.accent,
  );
  static Color get accentHover =>
      _theme.getColor('accentHover', accent.withValues(alpha: 0.85));
  static Color get accentActive =>
      _theme.getColor('accentActive', accent.withValues(alpha: 0.7));

  static Color get border => _theme.getColor(
    'border',
    _theme.isDark ? const Color(0x14FFFFFF) : const Color(0x1F000000),
  );
  static Color get divider => _theme.getColor(
    'divider',
    _theme.isDark ? const Color(0x0FFFFFFF) : const Color(0x14000000),
  );

  static Color get textPrimary => _theme.getColor(
    'textPrimary',
    _theme.isDark ? _fallbackText : AppColorsLight.textPrimary,
  );
  static Color get textSecondary => _theme.getColor(
    'textSecondary',
    _theme.isDark ? _fallbackSecondary : AppColorsLight.textSecondary,
  );
  static Color get textDisabled => _theme.getColor(
    'textDisabled',
    _theme.isDark ? _fallbackDisabled : AppColorsLight.textDisabled,
  );
...
abstract class AppTypography {
  ...
  static TextStyle get codePath => TextStyle(
    fontFamily: _mono,
    fontSize: 13,
    fontWeight: FontWeight.w400,
    color: AppColors.textSecondary,
